...
const HowItWorksPage = () => {
  ...
  <a
    ...
    className="
      ...
      hover:scale-105 hover:shadow-2xl hover:from-accent hover:to-primary
    "
  >
    <span className="relative z-10">📘 Basic Introduction to Diabetic Retinopathy</span>
    <span
      className="
  ...
  <img
    ...
    className="max-w-md w-full rounded-lg shadow-md border border-border"
  />
</div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 id-cols-4 gap-10">
